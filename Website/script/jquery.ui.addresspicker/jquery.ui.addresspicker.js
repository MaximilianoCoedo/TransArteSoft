...
(function ($, undefined) {
    ...
    $.widget("ui.addresspicker", {
        ...
        _create: function () {
            ...
            var geoRequest = { 'language': 'es' }
            //var geoRequest = { 'language': 'en' }
            this.geocoder = new google.maps.Geocoder(geoRequest);
            ...
            this.adressTarget = $(this.options.elements.adressTarget);
        ...
        _markerMoved: function () {
            var _selft = this;
            this._updatePosition(this.gmarker.getPosition());
            this.geocoder.geocode({ 'latLng': new google.maps.LatLng(this.lat.val(), this.lng.val()) },
            function (results, status) {
                if (status == google.maps.GeocoderStatus.OK) {
                    _selft.adressTarget.val(results[0].formatted_address);
                }
            });
        },
